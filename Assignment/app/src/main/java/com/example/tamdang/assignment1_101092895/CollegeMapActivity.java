...
public class CollegeMapActivity extends FragmentActivity
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng college = new LatLng(43.675916, -79.410747);
        mMap.addMarker(new MarkerOptions().position(college).title("Marker in GBC Casa Loma Campus"));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(college));
        polyline = mMap.addPolyline(new PolylineOptions().add(college));
    }
